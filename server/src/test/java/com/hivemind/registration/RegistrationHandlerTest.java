...
public class RegistrationHandlerTest {
    ...
    public void testRegistrationHandler_SuccessfulRegistration() {
        // Arrange
        User testUser = new User(0, "testUsername", "testPassword", "test@hivemind.com");
        ...
        verify(userDao, times(1)).getUserByEmail("test@hivemind.com");
    ...
    public void testRegistrationHandler_UsernameTaken() {
        // Arrange
        User testUser = new User(0, "existingUsername", "testPassword", "test@hivemind.com");
    ...
    public void testRegistrationHandler_EmailTaken() {
        // Arrange
        User testUser = new User(0, "newUsername", "testPassword", "existing@hivemind.com");
        ...
        verify(userDao, times(1)).getUserByEmail("existing@hivemind.com");
        verify(userDao, never()).addUser(any(User.class));
    }
}
